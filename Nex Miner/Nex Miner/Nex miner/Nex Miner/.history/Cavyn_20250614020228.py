                ...
                if event.key in [K_z, K_k]:
                    if len(projectiles) < 4: # Limit projectiles on screen
                        ...
                        if pressed_keys[K_UP] or pressed_keys[K_w]:
                            vel = [0, -proj_speed]
                            proj_pos = [player.centerx, player.rect.top]
                        elif pressed_keys[K_DOWN] or pressed_keys[K_s]:
                            vel = [0, proj_speed]
                            proj_pos = [player.centerx, player.rect.bottom]
                        elif player.flip[0]: # Facing right
                            vel = [proj_speed, 0]
                            proj_pos = [player.rect.right, player.centery]
                        else: # Facing left
                            vel = [-proj_speed, 0]
                            proj_pos = [player.rect.left, player.centery]

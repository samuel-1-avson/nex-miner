...
class CurseSelectionState(State):
    ...
    # REMOVED: The enter_state method was here. It contained logic copied from
    # GameplayState which caused an AttributeError because this state does not
    # have attributes like 'perks_gained_this_run'. The logic to decide
    # when to show this screen belongs solely in GameplayState.

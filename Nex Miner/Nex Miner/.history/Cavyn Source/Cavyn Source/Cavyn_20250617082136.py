...
class Game:
    ...
    def __init__(self):
        ...
        self.unlock_notifications = set() # NEW: To track new unlocks

    def notify_unlock(self, category): # NEW: Method to add a notification
        """Flags that a new item in a category has been unlocked."""
        self.unlock_notifications.add(category)

    def clear_notification(self, category): # NEW: Method to clear a notification

...
class Game:
    ...
    def __init__(self):
        ...
        self.SCALE = 4 # --- MODIFIED: Increased default scale for a larger window ---
        self.TILE_SIZE = 16
        pygame.display.set_caption('Cavyn: Recharged')
        # --- MODIFIED: Added RESIZABLE flag to the display mode ---
        self.screen = pygame.display.set_mode((self.DISPLAY_SIZE[0] * self.SCALE, self.DISPLAY_SIZE[1] * self.SCALE), RESIZABLE, 32)
    ...
    def run(self):
        while True:
            ...
            # --- NEW: Handle window resize event at the top level ---
            for event in events:
            ...
            # Final blit to the screen. This is automatically adaptive.

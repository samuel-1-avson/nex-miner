--- START OF FILE Nex Miner/Nex Miner/Nex Miner/Nex miner/Nex Miner/data/scripts/anim_loader.py ---
...
# (Other methods in Animation and AnimationManager are okay, no changes needed for them)
# For brevity, only showing the classes with changes. The original file can be assumed if no changes are shown.

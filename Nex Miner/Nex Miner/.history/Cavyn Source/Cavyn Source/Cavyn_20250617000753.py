...
class Game:
    ...
    def __init__(self):
        ...
        try:
            self.ai_agent = GeminiAgent(api_key="AIzaSyBsRGlo1wmmvBIfEzwII-zs2d6xxvopIpM") # Use your real key here
        except Exception: # Broad exception to catch any failure in API setup
            self.ai_agent = None # Handle case where API key is not set or library is missing
        # State Management
        self.states = []
        ...
        self.original_volumes = {
            ...
            'warp': 1.0, 'land': 0.4,
            'prophecy_complete': 1.0, 'artifact_equip': 0.7 # For new systems
        }
    ...
    def load_assets(self):
        ...
        # --- NEW: Sound placeholders ---
        self.sounds['prophecy_complete'] = self.sounds.get('upgrade', pygame.mixer.Sound(self.get_path('data', 'sfx', 'chest_open.wav')))
        self.sounds['artifact_equip'] = self.sounds.get('coin', pygame.mixer.Sound(self.get_path('data', 'sfx', 'coin.wav')))
        self.item_icons = {
    ...
    def load_save(self):
        ...
        try:
            with open(SAVE_FILE, 'r') as f:
                ...
                if 'artifacts' not in data: data['artifacts'] = {"unlocked": [], "equipped": None} # Added for artifacts system
                if 'active_prophecy' not in data: data['active_prophecy'] = None # Added for prophecy system
                # ---
                return data
            ...
            default_save = {
                ...
                "artifacts": {"unlocked": [], "equipped": None}, # Default for artifacts
                "active_prophecy": None, # Default for prophecies
            }

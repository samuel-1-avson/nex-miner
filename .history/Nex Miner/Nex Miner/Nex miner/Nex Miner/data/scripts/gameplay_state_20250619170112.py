    ...
    def render_hud(self, surface):
        ...
        if self.directive:
            ...
            if self.directive.get('completed', False):
                ...
                self.game.font_highlight.render(text, surface, (15 + self.game.white_font.width(prefix), y_pos))
                self.game.white_font.render(progress, surface, (15 + self.game.white_font.width(prefix) + self.game.font_highlight.width(text) + 5, y_pos))

...
from data.scripts.core_funcs import load_img
...
class Game:
    ...
    def load_configs(self):
        ...
        try:
            ...
            with open(config_paths['curses'], 'r') as f:
    ...
    def load_assets(self):
        ...
        # --- FIX ---
        # Explicitly load sounds that may not follow the standard naming convention
        # or that need to be duplicated under a different key.
        ...
        # ADDED: This line was missing, causing the crash.
        self.sounds['land'] = pygame.mixer.Sound(self.get_path('data', 'sfx', 'land.wav'))

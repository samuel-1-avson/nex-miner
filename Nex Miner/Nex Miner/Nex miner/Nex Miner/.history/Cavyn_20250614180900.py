...
class Game:
    ...
    def __init__(self):
        ...
        self.original_volumes = {
            ...
            # Add defaults for sounds without specific settings
    ...
    def load_biome_bgs(self, biome_info):
        ...
        try:
            bg_far_path = self.get_path(biome_info['bg_layers'][0])
            bg_near_path = self.get_path(biome_info['bg_layers'][1])
    ...
    def load_save(self):
        ...
        try:
            with open(SAVE_FILE, 'r') as f:
                ...
                # Add default settings if they don't exist in the save file
    ...
    def run(self):
        ...
        while True:
            ...
            # The current state handles events and updates
            current_state = self.get_current_state()
            if not current_state: break # Exit if no states are left
            ...
            render_offset = [0, 0]
            # Check if screen shake is enabled in settings before applying it

    ...
    def load_configs(self):
        ...
        try:
            config_paths = {
                ...
                'characters': self.get_path('data', 'configs', 'characters.json') # <-- ADDED
            }
            ...
            with open(config_paths['characters'], 'r') as f: # <-- ADDED
    ...
    def load_save(self):
        ...
        try:
            with open(SAVE_FILE, 'r') as f:
                ...
                # ---- MODIFIED: Handle new character data ---
            ...
            default_save = {
                ...
                "characters": {"unlocked": ["cavyn"], "selected": "cavyn"} # <-- ADDED
            }

...
class CharacterSelectState(State):
    ...
    def render_character_display(self, surface):
        ...
        if self.player_anim and self.player_anim.img:
            ...
            surface.blit(self.game.font_red.swap_color(char_img_large, (140, 245, 250)), (char_pos_x+offset, char_pos_y), special_flags=pygame.BLEND_RGBA_ADD)
            surface.blit(self.game.font_blue.swap_color(char_img_large, (140, 245, 250)), (char_pos_x-offset, char_pos_y), special_flags=pygame.BLEND_RGBA_ADD)

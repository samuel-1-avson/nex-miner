...
# This makes all relative paths (like 'data/images/...') work reliably.
os.chdir(os.path.dirname(os.path.abspath(__file__)))

# Now, we are GUARANTEED to be in 'C:\Users\HP\Downloads\Cavyn Source' when this script runs.
# Python automatically adds the current working directory to its path.
# --- END OF FIX ---
...
from data.scripts.states import State

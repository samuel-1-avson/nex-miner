...
tile_img = load_img('data/images/platform.png') # New Platform Tile
placed_tile_img = load_img('data/images/placed_platform.png') # New Placed Platform Tile
            ...
            if not dead:
                ...
                if event.key in [K_z, K_k]:
                    if len(projectiles) < 4: # Limit projectiles on screen
                        ...
                        vel = [4, 0]
                        proj_pos = player.center.copy()
                        if not player.flip[0]: # Facing left
                            vel[0] *= -1
                            proj_pos[0] -= player.size[0]

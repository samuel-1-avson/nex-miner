...
try:
    background_layers = [
        pygame.transform.scale(pygame.image.load('data/images/background_layer1.png').convert_alpha(), DISPLAY_SIZE),
        pygame.transform.scale(pygame.image.load('data/images/background_layer2.png').convert_alpha(), DISPLAY_SIZE),
    ]
except pygame.error:

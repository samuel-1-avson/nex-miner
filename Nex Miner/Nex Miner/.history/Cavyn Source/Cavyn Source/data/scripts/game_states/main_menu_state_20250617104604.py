...
from ..core_funcs import load_img # --- FIX: Import the load_img function
...
class MainMenuState(State):
    def __init__(self, game):
        ...
        # Dynamic Background
        try:
            # --- FIX: Call load_img directly ---
            self.bg_far = load_img(self.game.get_path('data', 'images', 'background.png'))
            self.bg_near = load_img(self.game.get_path('data', 'images', 'background_sunken.png'))

...
# Get the absolute path of the directory containing Cavyn.py
# e.g., 'C:\Users\HP\Downloads\Cavyn Source'
PROJ_DIR = os.path.dirname(os.path.abspath(__file__))

# Add this directory to Python's list of places to look for modules
if PROJ_DIR not in sys.path:
    sys.path.insert(0, PROJ_DIR)

# --- All other code and imports go below this line ---

import pygame
from pygame.locals import *

# Now, Python will know to look inside PROJ_DIR, find the 'data' folder,
# and these imports will resolve correctly.
from data.scripts.state import State
from data.scripts.state.gameplay_state import GameplayState

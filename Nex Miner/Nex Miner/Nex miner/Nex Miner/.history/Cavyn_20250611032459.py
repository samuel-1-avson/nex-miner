...
# --- Main Game Loop Function ---
def game_loop():
    # <-- MODIFIED: Add all shared variables to the global declaration
    global master_clock, game_timer, dead, last_place, height, target_height, combo_timer, combo_multiplier, banked_coins, game_state, end_coin_count, coins, player, tiles, tile_drops, bg_particles, sparks, current_item, item_used, stack_heights, items, COMBO_DURATION
    ...
    # ... (The rest of the game_loop function remains exactly the same)

...
class GameplayState(State):
    ...
    def reset(self):
        ...
        character_data = self.game.characters.get(selected_char_key, self.game.characters['cavyn']) # Fallback to default
        ...
        # Apply character-specific mods
        self.active_perks = set(character_data['mods'].get('innate_perks', []))
        self.player.FOCUS_DASH_COST = character_data['mods'].get('FOCUS_DASH_COST', 50) # Use mod, or default to 50

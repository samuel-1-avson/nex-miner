...
# --- NEW: 9-Slice Panel Rendering Function ---
...
class GameplayState(State):
    ...
    def load_state_assets(self):
        ...
        self.spike_tile_img = load_img(self.game.get_path('data', 'images', 'spike.png'))
        self.magnetic_tile_img = load_img(self.game.get_path('data', 'images', 'magnetic.png'))
        self.sticky_tile_img = load_img(self.game.get_path('data', 'images', 'sticky.png'))
        self.motherlode_tile_img = load_img(self.game.get_path('data', 'images', 'motherlode.png'))
        self.unstable_tile_img = load_img(self.game.get_path('data', 'images', 'unstable.png'))
        ...
        self.item_icons = {
            ...
            'hourglass': load_img(self.game.get_path('data', 'images', 'hourglass_icon.png')),
        }
    ...
    def render_hud(self, surface):
        # --- TOP LEFT: Score and Time-Slow Meter ---
        ...
        # Icon in the middle
        surface.blit(self.item_icons['hourglass'], (time_meter_center[0] - self.item_icons['hourglass'].get_width()//2, time_meter_center[1] - self.item_icons['hourglass'].get_height()//2))
        ...
        # --- TOP RIGHT: Item and Ability Panel ---
        ...
        if self.current_item:
            ...
            surface.blit(self.item_icons[self.current_item], (item_slot_pos[0] + 5, item_slot_pos[1] + 5))
        ...
        # Focus/Dash Meter (Horizontal Bar)

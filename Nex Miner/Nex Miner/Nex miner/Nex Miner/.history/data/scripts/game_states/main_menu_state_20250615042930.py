...
class MainMenuState(State):
    ...
    def select_submenu_option(self):
        ...
        if option == "CLASSIC": self.game.push_state(GameplayState(self.game, mode="classic"))
        elif option == "ZEN MODE": self.game.push_state(GameplayState(self.game, mode="zen"))
        elif option == "HARDCORE": self.game.push_state(GameplayState(self.game, mode="hardcore"))
        elif option == "CHALLENGES": print("Note: Challenge Mode requires a ChallengeSelectState to be implemented.")
        self.in_submenu = False

...
class GameplayState(State):
    ...
    # ... load_state_assets is unchanged ...
    ...
    def render(self, surface):
        ...
        # --- NEW: render ghosts behind player ---
    ...
    # ... All other methods from recalculate_stack_heights() to render_hud() are unchanged ...
    # OMITTING FOR BREVITY. The file is long, but these are the only changes.

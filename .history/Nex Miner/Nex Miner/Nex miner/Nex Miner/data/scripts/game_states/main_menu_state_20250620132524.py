...
class MainMenuState(State):
    ...
    def render_title(self, surface):
        ...
        if self.logo_img:
            ...
            logo_pos_y = 15 + y_bob
            surface.blit(self.logo_img, (logo_pos_x, logo_pos_y))
            y_offset = logo_pos_y + self.logo_img.get_height() - 5
        ...
        w_sub = self.font_main.width(sub_header); self.font_main.render(sub_header, surface, (surface.get_width()//2 - w_sub//2, y_offset))

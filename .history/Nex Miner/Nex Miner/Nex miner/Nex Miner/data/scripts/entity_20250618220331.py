...
class Entity:
    ...
    def set_action(self, action_id, force=False):
        ...
        if not is_valid_specific_anim and self.type in ['operator', 'infiltrator', 'demolitionist']:
            # This updated check ensures any character without its own unique sprites
            # will correctly fall back to the default 'player' sprites.

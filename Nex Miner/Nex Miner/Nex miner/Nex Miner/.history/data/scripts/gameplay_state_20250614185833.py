...
# The 'normalize' function has been moved to core_funcs.py
...
class GameplayState(State):
    ...
    def reset(self):
        ...
        self.dead = False # Internal flag to prevent multiple death triggers
        ...
        self.active_perks, self.last_perk_score = set(), 0

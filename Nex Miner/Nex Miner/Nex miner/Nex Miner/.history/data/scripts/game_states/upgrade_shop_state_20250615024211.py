...
class UpgradeShopState(State):
    def __init__(self, game):
        ...
        self.upgrade_icon_map = {
            ...
            "speed": None, # No specific icon for speed
            "item_luck": self.game.item_icons.get('cube'), # Using cube as a proxy for items
    ...
    def render(self, surface):
        ...
        # Consistent position for banked coins

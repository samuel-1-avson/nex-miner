...
class GameplayState(State):
    ...
    def update(self):
        self.master_clock += 1
        self.update_time_scale() # Sets player_time_scale and world_time_scale

        # World-based updates use world_time_scale
        if not self.dead:
            if self.mode != "challenge":
        ...
        # Player update always uses its own time scale
        self.update_player()
    ...
    def update_time_scale(self):
        # --- MODIFIED: Separate player and world time scales ---
        self.player_time_scale = 1.0
        self.world_time_scale = 1.0
        ...
        if self.slowing_time:
            self.world_time_scale = 0.4 # Slow the world down
